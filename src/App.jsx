...
import TripsInProgress from './components/trips/TripsInProgress.jsx';

import TripsInProgressDriver from './components/trips/TripsInProgressDriver.jsx';
    ...
    <Router>    
      <div className="main-content">
        ...
        <Routes>
          ...
          <Route path="/trips-progress" element={<TripsInProgress/>} />
          <Route path="/trips-progress-driver" element={<TripsInProgressDriver/>} />
        </Routes>
      </div>
    </Router>
  );
